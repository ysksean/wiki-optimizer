...
function baselineBlock(base, filter, acc, oursKey, ceilingKey) {
  ...
  if (floor && acc != null && acc < floor.accuracy) html += `<p>${t("bl_below_floor")}</p>`;
